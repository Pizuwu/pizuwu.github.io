...
const PROJEKT = /frame|carrosserie|body.?(chassis|shell)|karosserie\b|rolling|schlacht|ersatzteil|onderdel|teiletr|restauratie|restaurations?basis|restaur[a-z]*objekt|restoration|te restaureren|gerestaureerd worden|projec?t\b|projekt|basis\b|ohne motor|zonder motor|no engine|motorschaden|unfall|accident|gereviseerd worden|barn find|scheunenfund/i;
