...
## Mail-Politik (Patricks Entscheidung 13.09. abends: NUR NOCH BEI ECHTEN FUNDEN)
Mail NUR, wenn nach Recherche UND Tiefenprüfung mindestens ein NEUES, belegt fahrbereites Auto im Profil gefunden wurde, oder bei einem Preis-Drop/Verkauf in der bestehenden Liste, oder bei einer Verkäufer-Antwort/Betrugswarnung im Funnel. KEINE "keine Veränderung"-Mails mehr, auch nicht täglich. Format wie gehabt (Link, Preis, km, EZ, Ort, Einschätzung, Red Flags). state.json-Datumslogik entfällt für Digests; Funnel-Nachfass-Erinnerungen nur in Mails, die ohnehin wegen eines Fundes rausgehen, oder als eigene Mail wenn >72h überfällig. Betreff: `[ALERT 8/10] 911 SC Targa 31.5k 1981 privat DE` (ALERT-Prefix ab 8). Score 5-6: nur sammeln für Sonntags-Digest, KEINE Mail. Nichts Neues über der Schwelle und keine fällige Funnel-Aktion → **komplett still**.
